...
def _compute_one_split(G, output_path, owa=True, train_frac=1.0, num_fe_train=None, num_fe_test=None, split_id=0):
    r"""
...
def compute_splits_parallel(G, output_path, owa=True, train_frac=1.0, num_fe_train=None, num_fe_test=None,
                            num_splits=10):
    r"""
...
def split_train_test(G, train_frac=1.0):
    r"""
...
def naive_split_train_test(G, train_frac=1.0):
    r"""
    Computes one train/test split of edges from an input graph and returns the results.

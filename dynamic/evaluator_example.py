...
def eval_other(nee):
    ...
    # Set the commands
    #commands_other = [
    #    'python ./evalne/methods/PRUNE/src/main.py --inputgraph {} --output {} --dimension {}',
    #    './evalne/methods/metapath2vec/metapath2vec -min-count 1 -iter 20 -samples 100 -train {} -output {} -size {}']
